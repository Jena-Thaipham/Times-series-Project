...
```{r}
immigrant_ts <- ts(CAN_transform$Immigrants, start = 1972, frequency = 1) 
...
## ACF and PACF plot
```{r warning = FALSE}
# Plot ACF and PACF for CAN_ts$Immigrants
par(mfrow = c(2, 1)) # Set plot layout to 2 rows, 1 column
ggAcf(CAN_ts$Immigrants, main = "ACF of CAN_ts$Immigrants")
ggPacf(CAN_ts$Immigrants, main = "PACF of CAN_ts$Immigrants")

# Plot ACF and PACF for CAN_transform$Immigrants
par(mfrow = c(2, 1)) # Set plot layout to 2 rows, 1 column
ggAcf(CAN_transform$Immigrants, main = "ACF of CAN_transform$Immigrants")
ggPacf(CAN_transform$Immigrants, main = "PACF of CAN_transform$Immigrants")
